...
namespace SistemaCsharp_Pitbullnet
{
    public partial class frmInicio : Form
    {
        ...
        private void btnIf_Click(object sender, EventArgs e)
        {
            ...
            {
                int datosif = 0;
                datosif = int.Parse(txtValor1.Text);
                if (datosif == 1)
                {
            ...
            catch (Exception error)
            {
                ...
                MessageBox.Show( "Ingresa un numero de 1 a 10  en valor1"+" "+error.Message);
        ...
        private void btnSwitch_Click(object sender, EventArgs e)
        {
            #region switch
            int opcion;
            opcion = int.Parse(txtValor1.Text);
            switch (opcion)
            {
                case 1:
                    lstDatos.Items.Add("Bien Hecho Opcion1");
                    break;
                case 2:
                    lstDatos.Items.Add("Casi, Opcion2");
                    break;             
                default:
                    lstDatos.Items.Add("Intentalo de nuevo");
                    break;
        ...
        {          
            ...
            lstDatos.Items.Add(ccm1.suma(2, 4));
            #endregion
            ...
            ClaseConMetodos ccm2 = new ClaseConMetodos();
             ...
             lstDatos.Items.Add(ccm2.sumacontexbox(ccm2.valor1,ccm2.valor2));
            #endregion
        ...
        {
            frmBaseDeDatos1 frmbdd1 = new frmBaseDeDatos1();
            frmbdd1.Show();
        }
